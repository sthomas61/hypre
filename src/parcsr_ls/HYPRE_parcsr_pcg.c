...
HYPRE_Int
HYPRE_ParCSRPCGCreateMP( MPI_Comm comm, HYPRE_Solver *solver, HYPRE_Precision solver_precision )
{
   ...
   *solver = ( (HYPRE_Solver) hypre_PCGCreate( pcg_functions, solver_precision ) );
