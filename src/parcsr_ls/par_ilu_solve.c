      ...
      switch (ilu_type)
      {
         case 0: case 1:
            ...
            if ( tri_solve == 1 )
                ...
                hypre_ILUSolveCusparseLUIter(matA, matL_des, matU_des, matBLU_d,
         ...
         case 10: case 11:
            ...
            {
               hypre_ILUSolveCusparseSchurGMRESIter(matA, F_array, U_array, perm, nLU, matS, Utemp, Ftemp,
                                                    schur_solver, schur_precond, rhs, x, u_end,
                                                    matL_des, matU_des, matBLU_d, matE_d, matF_d,
                                                    Ztemp, &Adiag_diag, &Sdiag_diag, lower_jacobi_iters, upper_jacobi_iters);//GMRES-cusparse
         ...
         default:
             ...
             {
                hypre_ILUSolveCusparseLUIter(matA, matL_des, matU_des, matBLU_d,
                                             F_array, U_array, perm, n, Utemp, Ftemp,
...
*/
HYPRE_Int
hypre_ILUSolveCusparseLUIter(hypre_ParCSRMatrix *A, cusparseMatDescr_t matL_des,
                             cusparseMatDescr_t matU_des, hypre_CSRMatrix *matLU_d,
...
HYPRE_Int
hypre_ILUSolveCusparseSchurGMRESIter(hypre_ParCSRMatrix *A, hypre_ParVector *f,
                                     hypre_ParVector *u, HYPRE_Int *perm,
                                     ...
                                     HYPRE_Int lower_jacobi_iters, HYPRE_Int upper_jacobi_iters)
{
   ...
   if (!S)
   {
      ...
      return hypre_ILUSolveCusparseLUIter(A, matL_des, matU_des, matBLU_d,
