                                       ...
                                       hypre_CSRMatrix   **B )
{
   ...
   *B                               = hypre_CSRMatrixCreate(n, n, nnz);
   ...
   HYPRE_Int               *rqperm_dev          = NULL;
   rqperm_dev                                   = hypre_CTAlloc(HYPRE_Int, n, HYPRE_MEMORY_DEVICE);
   hypre_TMemcpy(rqperm_dev, rqperm, HYPRE_Int, n, HYPRE_MEMORY_DEVICE, HYPRE_MEMORY_HOST);
   ...
   hypreDevice_CSRMatrixPermuteColsVals(n, nnz, perm, rqperm_dev, A_i, A_j, A_data, B_i, B_j, B_data);

   /* Free temporary memory */
   hypre_TFree(rqperm_dev, HYPRE_MEMORY_DEVICE);
